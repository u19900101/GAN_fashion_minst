    ...
    def sample_images(self, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i, j].axis('off')
                cnt += 1
        fig.savefig("fashion_mnist_cgan_cnn/%d.png" % epoch)
        plt.close()
...
if __name__ == '__main__':
    if not os.path.exists("./fashion_mnist_cgan_cnn"):
        os.makedirs("./fashion_mnist_cgan_cnn")
    acgan = ACGAN()
    acgan.train(epochs=2000, batch_size=256, sample_interval=5)
